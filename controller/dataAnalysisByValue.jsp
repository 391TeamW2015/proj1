...
<% 
	if(request.getParameter("go1") != null)
        {			
			...
			out.println("<br><br><br><br><br><br><br><br><H1><CENTER>Data Analysis</CENTER></H1><CENTER><P><CENTER>Please Enter the Value for the Attributes</CENTER></P>");
			out.println("<br><FORM ACTION='dataAnalysisByValueResult.jsp' METHOD='post' >");
			...
			out.println("<script language='JavaScript'>var i ;for(i=2015; i>=1900; i--){ document.write('<option value='+i+'><fond color=black>'+i+'</option>') ;}");
			...
			out.println("<script language='JavaScript'>var i ;for(i=2015; i>=1900; i--){ document.write('<option value='+i+'><fond color=black>'+i+'</option>') ;}</script>");
			...
			out.println("<INPUT TYPE='submit' NAME='search1' VALUE='Analysis' style= 'width: 300; height: 30'></FORM>");
			out.println("<bR><FORM ACTION='../view/dataAnalysis.html' METHOD='post' ><INPUT TYPE='submit' VALUE='BACK' style= 'width: 150; height: 30'></FORM>");
