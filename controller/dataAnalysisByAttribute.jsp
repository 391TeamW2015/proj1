...
<% 
	if(request.getParameter("go2") != null)
        {			
			...
			out.println("<br><FORM ACTION='dataAnalysisByAttributeResult.jsp' METHOD='post' ><table><tr><td><input type='checkbox' name='name1'></td><td>Name</td></tr><tr><td><input type='checkbox' name='type'></td><td>Test Type</td></tr>");
			...
			out.println("<INPUT TYPE='submit' NAME='search2' VALUE='Analysis' style= 'width: 300; height: 30'></FORM>");
			
			
			out.println("<br><br><FORM ACTION='../view/dataAnalysis.html' METHOD='post' ><INPUT TYPE='submit' VALUE='BACK' style= 'width: 150; height: 30'></FORM>");
